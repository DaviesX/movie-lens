...
def main(training_mode: bool):
    ...
    dataset.save_dense_array(file="../data/latent_dnn_movie.npz", arr=movie_embed)
    ...
    dataset.save_dense_array(file="../data/ldnn_preds_train.npz", arr=pred_ratings_train)
    dataset.save_dense_array(file="../data/ldnn_preds_valid.npz", arr=pred_ratings_valid)
